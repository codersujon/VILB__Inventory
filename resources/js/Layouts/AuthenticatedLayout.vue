                            ...
                            <div class="user-box">
                                ...
                                <div class="main-friend-list">
                                    <div class="media userlist-box" data-id="1" data-status="online"
                                        ...
                                        <a class="media-left" href="#!">
                                            <img class="media-object img-radius img-radius"
                                                src="../../../public/backend/files/assets/images/avatar-3.jpg"
                                    ...
                                    <div class="media userlist-box" data-id="2" data-status="online"
                                        ...
                                        <a class="media-left" href="#!">
                                            <img class="media-object img-radius"
                                                src="../../../public/backend/files/assets/images/avatar-2.jpg"
                                                alt="Generic placeholder image">
                                            <div class="live-status bg-success"></div>
                                        </a>
                                        <div class="media-body">
                                    ...
                                    <div class="media userlist-box" data-id="3" data-status="online"
                                        ...
                                        <a class="media-left" href="#!">
                                            <img class="media-object img-radius"
                                                src="../../../public/backend/files/assets/images/avatar-4.jpg"
                                                alt="Generic placeholder image">
                                            <div class="live-status bg-success"></div>
                                        </a>
                                        <div class="media-body">
                ...
                <div class="showChat_inner">
                    ...
                    <div class="media chat-messages">
                        <a class="media-left photo-table" href="#!">
                            <img class="media-object img-radius img-radius m-t-5"
                                src="../../../public/backend/files/assets/images/avatar-3.jpg" alt="Generic placeholder image">
                        </a>
                    ...
                    <div class="media chat-messages">
                        ...
                        <div class="media-right photo-table">
                            <a href="#!">
                                <img class="media-object img-radius img-radius m-t-5"
                                    src="../../../public/backend/files/assets/images/avatar-4.jpg" alt="Generic placeholder image">
                            </a>
                        </div>
                    </div>
