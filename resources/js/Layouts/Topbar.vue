            ...
            <div class="d-flex">
                ...
                <div class="navbar-brand-box">
                    <a href="index.html" class="logo logo-dark">
                        <span class="logo-sm">
                            <img src="../../../public/backend/assets/images/logo-sm.png" alt="logo-sm"
                                height="22">
                        </span>
                        <span class="logo-lg">
                            <img src="../../../public/backend/assets/images/logo-dark.png"
                    ...
                    <Link :href="route('dashboard')" class="logo logo-light">
                        <span class="logo-sm">
                            <img src="../../../public/backend/assets/images/logo-sm.png"
                                alt="logo-sm-light" height="22">
                        </span>
                        <span class="logo-lg">
                            <img src="../../../public/backend/assets/images/logo-light.png"
            ...
            <div class="d-flex">
                ...
                <div class="dropdown d-none d-sm-inline-block">
                    <button type="button" class="btn header-item waves-effect" data-bs-toggle="dropdown"
                        ...
                        <img class="" src="../../../public/backend/assets/images/flags/us.jpg"
                ...
                <div class="dropdown d-inline-block">
                    ...
                    <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end p-0"
                        ...
                        <div data-simplebar style="max-height: 230px;">
                            ...
                            <a href="" class="text-reset notification-item">
                                <div class="d-flex">
                                    <img src="../../../public/backend/assets/images/users/avatar-3.jpg"
                            ...
                            <a href="" class="text-reset notification-item">
                                <div class="d-flex">
                                    <img src="../../../public/backend/assets/images/users/avatar-4.jpg"
                                        class="me-3 rounded-circle avatar-xs" alt="user-pic">
                                    <div class="flex-1">
                ...
                <div class="dropdown d-inline-block user-dropdown">
                    <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                        ...
                        <img class="rounded-circle header-profile-user"
                            src="../../../public/backend/assets/images/users/avatar-1.jpg"
                            alt="Header Avatar">
